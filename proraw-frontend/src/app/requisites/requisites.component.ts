...
export class RequisitesComponent implements OnInit {
  ...
  [
      ...
      {name: "Юридический адрес", info: "РФ, 214032, г.Смоленск, ул.Маршала Еременко, д.8Б, офис Р2"},
      {name: "Фактический (почтовый) адрес", info: "РФ, 109387, г.Москва, ул.Люблинская, д.42, офис 326-1"},
